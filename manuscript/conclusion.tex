...
times the depth. Constraint preservation and connectivity are separate
design choices, and the second is not settled by maximizing it.

Two caveats on scope. The benchmark is not a reproduction of
...
size tested. Optimized values at every depth are lower bounds: on common
