...
At $(20,5)$, Fig.~\ref{fig:depth20}, the ordering inverts: with $p\le4$
...
$\beta^{2}/r$ and the gate count grows as $r$. A
...
$K_{\F}$ is the one unambiguous negative result: weakest at every size
